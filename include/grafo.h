...
class Grafo {
   public:
     ...
     * @param bidir Indica se o vértice é bidirecional ('true' por padrão)
     */
    ...
    /**
     * Percorre o grafo e verifica se existem componentes (um vértice ou um grupo de vértices)
     * não conectados ao resto do grafo.
    ...
    /**
     * Compara a distância de dois vértices representados por pares, onde o primeiro elemento
     * de cada par é o vértice, e o segundo a sua distância.
     */
    struct comparador {
   ...
   private:
    /**
     * 'Map' de vértices, contendo o vértice e sua lista ('vector') de adjacências,
     * cada um com sua distância do vértice
     */
